...
export default class ProfilePage extends React.Component {
  ...
  handleDisplayEditPage() {
    if (this.state.displayEditPage !== true) {
      this.setState({
  ...
  render() {
    if (this.state.displayEditPage === false) {
        ...
        <Box>
          <Box display="flex">
            <PersonalInfo
              ...
              handleDisplayEditPage={this.handleDisplayEditPage.bind(this)}
            />
      ...
      return (
        <Box>
          <EditDetails student={this.props.student} handleDisplayEditPage={this.handleDisplayEditPage.bind(this)} />
        </Box>
      );
    }
  }
